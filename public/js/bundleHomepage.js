...
})()(
  {
                      ...
                      module.exports = function (options) {
                        ...
                        function onMove(e, isTouch) {
                          ...
                          if (reverse) {
                            if (isTouch) {
                              xCoor =
                                e.changedTouches[0].pageX - parentOffset.left;
                            } else {
                              xCoor =
                                e.pageX - window.scrollX - parentOffset.left;
                            }
    ...
    3: [
      function (require, module, exports) {
        ...
        var reviewCount = document.querySelectorAll(".rater").length;
        for (let i = 0; i < reviewCount; i++) {
          var myRater = rater({
            element: document.querySelectorAll(".rater")[i],
